...
<div class="ui-report">
    ...
    <div class="form-inline response-head titlePanel" id="listTools">
        ...
        <div class="tools-btn" id="tools-btn">
            ...
            <div class="btn-group">
                <a id="template_link" class="btn btn-warning"><i class="fa fa-download"></i>下载模版</a>
            </div>
        </div>
    </div>
    <div id="tableBox">
...
<div id="add-edit" class="form-horizontal" data-value="" data-type=0>
    <div class="form-group" kk-contral="require">
        ...
        <div class="col-sm-9" >
            <input type="text" kk-prop="value" class="form-control" id="planName" placeholder="进度名称">
        </div>
    </div>
    <div class="form-group" kk-contral="require">
        <label class="col-sm-2 control-label">开始日期</label>
        <div class="col-sm-9">
            <input  type="text" kk-prop="value" class="form-control inputxt col-xs-8" kk-prop="value" id="startDate"  onclick="WdatePicker({maxDate:'#F{$dp.$D(\'endDate\')}',dateFmt:'yyyy-MM-dd'})"  placeholder="请选择日期" maxlength="4" readonly />
        </div>
    </div>
    <div class="form-group" kk-contral="require">
        <label class="col-sm-2 control-label">结束日期</label>
        <div class="col-sm-9">
            <input  type="text" kk-prop="value" class="form-control inputxt col-xs-8" kk-prop="value" id="endDate"  onclick="WdatePicker({minDate:'#F{$dp.$D(\'startDate\')}',dateFmt:'yyyy-MM-dd'})"  placeholder="请选择日期" maxlength="4" readonly />
        </div>
    </div>
    <div class="form-group" kk-contral="require">
...
<script type="text/javascript" src="${ctx}/resources/static/js/schedulePlan/schedulePlanList.js?v=${v}"></script>
