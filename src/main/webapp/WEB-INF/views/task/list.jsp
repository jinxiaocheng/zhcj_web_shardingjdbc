...
<script type="text/html" id="barDemo">
    ...
    {{# }}}
    {{#  if(type === 1){}}
    <a class="layui-btn layui-btn-xs layui-btn-warm" lay-event="operation">受理任务</a>
    {{#  } else if(type === 2 || type === 4){ }}
    <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="operation">提交任务</a>
    {{#  } else if(type === 3){ }}
    <a class="layui-btn layui-btn-xs " lay-event="operation">检查任务</a>
    {{#  } else { }}
...
<script type="text/html" id="statusTask">
    {{#  var type = d.statusTask}}
    {{#  if(type === 1){}}
...
<script type="text/javascript" src="${ctx}/resources/static/js/task/task.js?v=${v}"></script>
