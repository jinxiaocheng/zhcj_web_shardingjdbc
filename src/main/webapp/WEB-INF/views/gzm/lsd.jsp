...
<div class="biyue_body">
    <div class="biyue_search layui-form">
        <label class="layui-form-label" style="width: 120px;">流水段名称</label>
        <div class="layui-input-inline">
            <input type="text" name="name" placeholder="请输入流水段名称" autocomplete="off" class="layui-input" >
        </div>
...
<div class="endCd layui-form" style="display: none">
    <div class="layui-form-item" style="margin-top: 20px">
        <label class="layui-form-label" style="width: 100px">开始测量时间</label>
        <div class="layui-input-inline">
            <input id="start" type="text" name="startTime" placeholder="请输入开始测量时间" lay-verify="required" autocomplete="off" class="layui-input" >
        </div>
    </div>
    <div class="layui-form-item" style="margin-top: 20px">
        <label class="layui-form-label"  style="width: 100px">结束测量时间</label>
        <div class="layui-input-inline">
            <input id="end" type="text" name="endTime" placeholder="请输入结束测量时间" lay-verify="required" autocomplete="off" class="layui-input" >
        </div>
    </div>
</div>
...
<script type="text/html" id="barDemo">
    ...
    {{# }}}
    {{# if(type === 1){num++}}
    <a class="layui-btn layui-btn-xs layui-btn-danger" lay-event="close">结束</a>
    {{# }else{num++}}
    <a class="layui-btn layui-btn-xs layui-btn-danger layui-btn-disabled">结束</a>
    {{# }}}
    {{# if(num===0){}}
...
<script type="text/html" id="status">
    {{#  var type = d.status}}
    {{#  if(type === 2){}}
    <span style="color: #FF5722">结束</span>
    {{#  } else if(type === 1){ }}
    <span style="color: #5FB878">测量中</span>
    {{#  } else { }}
    <span>未知</span>
    {{#  } }}
</script>
...
<script type="text/javascript" src="${ctx}/resources/static/js/gzm/lsd.js?v=${v}"></script>
<script>
    $(function () {
        var area =biyue.area();
        area.area({
