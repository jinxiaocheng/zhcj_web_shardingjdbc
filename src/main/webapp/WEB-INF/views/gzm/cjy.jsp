...
<div class="biyue_body">
    <div class="biyue_search layui-form">
        <label class="layui-form-label" style="width: 120px;">采集仪名称/编号</label>
        <div class="layui-input-inline">
            <input type="text" name="name" placeholder="请输入采集仪名称/编号" autocomplete="off" class="layui-input" >
        </div>
...
<div class="editCJY layui-form" style="display: none">
    <div class="layui-form-item" style="margin-top: 20px">
        <label class="layui-form-label" style="width: 100px">采集仪名称</label>
        <div class="layui-input-inline">
            <input id="name" type="text" placeholder="请输入采集仪名称" lay-verify="required" autocomplete="off" class="layui-input" >
        </div>
    </div>
    <div class="layui-form-item" style="margin-top: 20px">
        <label class="layui-form-label"  style="width: 100px">采集仪编号</label>
        <div class="layui-input-inline">
            <input id="number" type="text"  placeholder="请输入采集仪编号" lay-verify="required" autocomplete="off" class="layui-input" >
        </div>
    </div>
</div>
<script type="text/html" id="status">
    {{#  var type = d.status}}
    {{#  if(type === 0){}}
    <span style="color: #FFB800">测量中</span>
    {{#  } else if(type === 1){ }}
    <span style="color: #5FB878">已启用</span>
    {{#  } else { }}
    <span>未知</span>
    {{#  } }}
</script>
...
<script type="text/javascript" src="${ctx}/resources/static/js/gzm/cjy.js?v=${v}"></script>
<script>
    $(function () {
        var area =biyue.area();
        area.area({
