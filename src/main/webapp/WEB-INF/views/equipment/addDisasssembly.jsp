    ...
    <form id="personform" class="form-inline add_form" action="javascript:void(0)">
        ...
        <div class="row add_list  " >
            <div class="form-group col-xs-4 " kk-contral="require">
                ...
                <input type="text" readonly onclick='kk_searchPage(constructionId)' kk-prop="value"  class="form-control inputxt col-xs-8" id='name' placeholder="请选择设备名称" maxlength="4" auto_color_flag="true" datatype="zh2-4" errormsg="长度为2-4位中文" />
                <input  type="text" class="form-control inputxt" id='id' style="display:none"/>

            </div>
            <div class="form-group col-xs-4 " kk-contral="require">
                <label class=" col-xs-4">安装拆卸时间</label>
                <input  type="text" class="form-control inputxt col-xs-8" kk-prop="value" id="disassemblyDate"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  placeholder="请选择日期" maxlength="4" readonly />
            </div>
            <div class="form-group col-xs-4  queryCondition" kk-contral="require">
                ...
                <ul class="dropdown-menu" style="min-width:108px;">
                    ...
                    <li ><a data-value="1">安装</a></li>
                    <li ><a data-value="2">拆卸</a></li>
                </ul>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function my_ajax() {
        ...
        //安装拆卸日期
        var disassemblyDate=$("#disassemblyDate").val();
        //备注信息
        ...
        formData.append("disassemblyDate",disassemblyDate)
        formData.append("type",type)
        formData.append("equipmentId",equipmentId)
        formData.append("remark",remark)
        var url = ctx + "/equipment/saveDisassembly";
        $.ajax({
            url:url,                              //后台请求地址
            data:formData,                            //自定义参数
            processData: false,
    ...
    function kk_searchPage(id){
        var _url = ctx + '/equipment/select?type=2&constructionId='+id;
        var _title = '请选择';
