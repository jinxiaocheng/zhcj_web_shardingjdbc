...
<div class="biyue_body">
    <div class="biyue_search layui-form">
        ...
        <div class="layui-input-inline">
            <input type="text" name="name" placeholder="请输入建设单位" autocomplete="off" class="layui-input">
        </div>
        ...
        <div class="search-more-box layui-anim layui-anim-upbit">
            ...
            <div class="layui-form-item site">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="building" placeholder="请输入设备类型" autocomplete="off" class="layui-input">
                </div>
            </div>
        </div>
    </div>
...
<script type="text/html" id="barDemo">
    ...
    {{#  } else if(operationAuthority[i]==="edit"){num++}}
...
<script type="text/html" id="status">
    ...
    {{#  } else if(type === 1){ }}
    <span style="color: #00d6e7">有效</span>
    {{#  } }}
</script>
<script type="text/html" id="type">
    {{#  var type = d.type}}
    {{#  if(type === 0){}}
    <span style="color: #1e9fff">市管工地</span>
    {{#  } else if(type === 1){ }}
    <span style="color: #00d6e7">区管工地</span>
    {{#  } else{ }}
    <span style="color: #c5c4c7">未知</span>
    {{#  } }}
</script>
...
<script type="text/javascript" src="${ctx}/resources/static/js/constructionList/constructionList.js?v=${v}"></script>
