...
<form class="form-inline add_form" id="materialForm">
    ...
    <div class="row add_list ">
        <div class="form-group col-xs-4" kk-contral="require">
            ...
            <input type="text" class="form-control col-xs-8 getMaterialData" kk-prop="data-value" id="materialName" placeholder="请选择材料名称" readonly>
        </div>
        <div class="form-group col-xs-4" >
            <label class=" col-xs-4">规格型号</label>
            <input type="text" class="form-control col-xs-8 getMaterialData"  id="materialModel" placeholder="请选择规格型号" readonly>
        </div>
        <div class="form-group col-xs-4" kk-contral="require">
            <label class=" col-xs-4">数量</label>
            <input type="text" class="form-control col-xs-8 " kk-prop="value" id="materialNum" kk-RE="num" kk-name="数量" placeholder="请输入数量">
        </div>
    </div>
    ...
    <div class="row add_list ">
        <div class="form-group col-xs-4" >
            ...
            <input type="text" class="form-control col-xs-8 getMaterialData"  id="materialUnit" placeholder="请选择单位" readonly>
        </div>
        <div class="form-group col-xs-4" kk-contral="require">
            <label class=" col-xs-4">材料总价(万元)</label>
            <input type="text" class="form-control col-xs-8" kk-prop="value" kk-RE="num" kk-name="材料总价" id="materialPrice" placeholder="请输入材料总价">
        </div>
    </div>
...
<script type="text/javascript" src="${ctx}/resources/static/js/common/openListPage.js?v=${v}"></script>
<script type="text/javascript">
    ...
    function my_ajax() {
        var url = ctx + "/materialBudget/add";
        $.ajax({
            type: "post",
            url:url,                              //后台请求地址
            data: {
                constructionId:$(".site button").attr("constructionid"),
                materialId:$("#materialName").attr("data-value"),
