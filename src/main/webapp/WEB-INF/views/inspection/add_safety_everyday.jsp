...
<form class="form-inline add_form" id="form_data">
    ...
    <div class="row add_list biyue-skewing " style="margin: 0;padding: 0">
    ...
    <div class="form-group all_block" style="width: 100%" >
        <textarea class="form-control remark"  style="width: 100%;" maxlength="500" placeholder="最多输入500字" kk-RE="textLength/0-500" kk-name="整改意见"  rows="3"></textarea>
    </div>
...
<script>
    ...
    function my_safetyAjax() {
       ...
       // 检查项数据
        ...
        if(Object.keys(window.kk_allData).length>0){
        	var person_allData=[]
        	for(var i in window.kk_allData){
        		person_allData.push(window.kk_allData[i])
        	}
