...
<div class="biyue_body">
    <div class="biyue_search layui-form">
        <label class="layui-form-label" style="">班组名称</label>
        <div class="layui-input-inline">
            <input type="text" name="itemName" placeholder="请输入班组名称" autocomplete="off" class="layui-input" >
        </div>
...
<script type="text/javascript" src="${ctx}/resources/static/js/team/team.js?v=${v}"></script>
