...
<div class="biyue_body">
    <div class="biyue_search layui-form">
        ...
        <div class="search-more-box layui-anim layui-anim-upbit">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label" style="">卡号</label>
                <div class="layui-input-inline">
                    <input type="text" name="cardNumber" placeholder="请输入卡号" autocomplete="off" class="layui-input" >
                </div>
            </div>
            <div class="layui-form-item">
    ...
    <div class="biyue_tool">
        ...
        <button class="layui-btn layui-btn-primary" id="createUser"><i class="fa fa-user-plus"></i>生成用户</button>
        <button class="layui-btn layui-btn-primary" id="import_link"><i class="fa fa-sign-out"></i>导入</button>
        <button class="layui-btn layui-btn-primary" id="export_link"><i class="fa fa-download"></i>导出</button>
        <button class="layui-btn layui-btn-primary" id="template_link"><i class="fa fa-download"></i>下载模版</button>
    </div>
...
<script type="text/html" id="barDemo">
    ...
    {{# }else if(operationAuthority[i]==="allotDoor"){num++}}
    <a class="layui-btn layui-btn-xs layui-btn-normal" data-id="{{d.id}}" lay-event="allotDoor">分配门</a>
    {{# }}}
    {{# }}}
    {{# if(num===0){}}
...
<script>
    var ctx = "${ctx}",userId="${userId}",path = '<%=path%>';
</script>
...
<script type="text/javascript" src="${ctx}/resources/static/js/person/person.js?v=${v}"></script>
