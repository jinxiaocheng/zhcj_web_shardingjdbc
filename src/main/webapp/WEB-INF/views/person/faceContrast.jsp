...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/resources/static/css/person/faceContrast.css?v=${v}"/>
    <!--[if lt IE 9]>
...
<div class="ui-report">
    ...
    <div class="form-inline response-head titlePanel" id="listTools">
        ...
        <div id="search-input" class="collapse">
            ...
            <div class="ui-filter">
                <label>姓名:</label>
                <input id="name" class="form-control w-110" />
            </div>
            <div class="ui-filter">
                <label>身份证:</label>
                <input id="idCard" class="form-control w-110" />
            </div>
    ...
    <div class="wrapper">
        <ul>
           <%-- <li>
                <h2><i></i>恒信入口1</h2>
                <div class="aisle-box">
                    <div class="faceContrast-box">
                        <div class="imgA"><img src="${ctx}/resources/static/images/test/1.jpg" alt=""></div>
                        <div class="imgB"><img src="${ctx}/resources/static/images/test/1.jpg" alt=""></div>
                        <div class="faceContrast-info">
                            <p class="percent"><label>相似度:</label><span>90%</span></p>
                            <p class="name"><label>姓名:</label><span>孔正</span></p>
                            <p class="idCard"><label>身份证:</label><span>420984199502022417</span></p>
                            <p  class="img-time"><label>时间:</label><span>2018-11-8 11:34:44</span></p>
...
<div class="popoverBox">
    ...
    <div id="laypage1" class="laypage"></div>
</div>
...
<script type="text/javascript" src="${ctx}/resources/static/js/person/faceContrast.js?v=${v}"></script>
<script>
    $(function () {
        var date = new Date();
        init(function(){
        ...
        getFaceInfo();
        openWin('/faceRecognition/listContrastTrack');
