...
<div class="biyue_body">
    <div class="biyue_search layui-form">
        <label class="layui-form-label" style="width: 100px">岗位/工种名称</label>
    ...
    <div class="biyue_tool">
        ...
        <button class="layui-btn layui-btn-primary" id="refresh_link"><i class="fa fa-mail-reply-all"></i>初始化数据</button>
    </div>
...
<script type="text/javascript" src="${ctx}/resources/static/js/positionWork/positionWork.js?v=${v}"></script>
