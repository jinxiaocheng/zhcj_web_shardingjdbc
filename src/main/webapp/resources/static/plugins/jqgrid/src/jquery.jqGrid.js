...
$.extend($.jgrid,{
	...
	clearBeforeUnload : function( jqGridId ) {
		...
		$(grid.hDiv).off("mousemove"); // aTODO add namespace
		$($t).off();
...
$.jgrid.extend({
	...
	setFrozenColumns : function () {
		return this.each(function() {
			...
			// aTODO treeGrid and grouping  Support
		...
		if (editable==="1") {
			...
			if(tmp) {
				...
				if (tmp[idname] === undefined || tmp[idname]==="") {
					...
					// aTODO: to test the case of frozen columns
				}
