package com.escst.commons.reflect;
...
public class ReflectUtil {
    ...
    public static void main(String[] args) {
        try {
            Class<PersonEntity> clazz = PersonEntity.class;
            PersonEntity personEntity = ReflectUtil.invokeConstructor(clazz,null,null);
            System.out.println(personEntity);
            ReflectUtil.invokeSetter(personEntity, "name", "张三");
            System.out.println(personEntity);
            Object ret = ReflectUtil.invokeGetter(personEntity, "name");
