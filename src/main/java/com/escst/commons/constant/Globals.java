package com.escst.commons.constant;
...
public final class Globals {
	...
	/**
	 * @Fields TITLE_FOREMAN_ID 工长的岗位ID
	 */
	public static final String TITLE_ID_FOREMAN = "4fb04fe8057311e7a0d9002590f074f8";

	/**
	 * @Fields TITLE_ID_TEAM_LEADER 班组长的岗位ID
	 */
	public static final String TITLE_ID_TEAM_LEADER = "82f1c6f3150911e7b3fab82a72dd25a2";

	/**
	 * @Fields USER_DEFAULT_PASSWORD 用户初始密码
	 */
