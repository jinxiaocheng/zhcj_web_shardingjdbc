...
<form class="layui-form pop-box" lay-filter="biyueOpen" action="#" method="post" enctype="multipart/form-data">
        ...
        <div class="layui-inline area_edit" style="display: none">
            ...
            <div class="layui-input-inline ">
                <input type="text" name="areaName" lay-verify="required" class="layui-input" readonly
                       placeholder="区域名称" value="${map.terrName}">
        ...
        <div class="layui-inline site_edit" style="display: none">
            ...
            <div class="layui-input-inline site_edit">
                <input type="text" name="constructionName" lay-verify="required" class="layui-input" readonly
                       placeholder="工地名称" value="${map.constructionName}">
    ...
    <div class="layui-form-item">
        <div class="layui-form-item company">
            ...
            <div class="layui-input-block">
                <select name="company" lay-search lay-verify="required" lay-filter="company">
                    <option value="">选择公司</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item company_edit" style="display: none">
            <label class="layui-form-label">公司</label>
            <div class="layui-input-block company_edit">
                <input type="text" name="companyName" value="${map.companyName}" lay-verify="required" class="layui-input" readonly
                       placeholder="公司名称">
            </div>
        </div>
        <div class="layui-form-item teamName" style="display: none">
            <label class="layui-form-label">班组名称</label>
            <div class="layui-input-block">
                <input type="text" name="name" value="${map.name}" lay-verify="required" placeholder="请输入公司名称" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
    ...
    <div class="teamList" style="width: 100%">
        ...
        <button type="button" class="layui-btn" id="add-channel"><i class="layui-icon layui-icon-add-circle-fine" style="display: inline-block"></i>新增班组</button>
        <button type="button" class="layui-btn  layui-btn-normal" id="add-model"><i class="layui-icon layui-icon-add-circle-fine" style="display: inline-block"></i>选择班组模板</button>
...
<script type="text/javascript" src="${ctx}/resources/static/js/team/teamAdd.js?v=${v}"></script>
<script>
    $(function () {
        biyue.verify();
        biyue.popDefault();
