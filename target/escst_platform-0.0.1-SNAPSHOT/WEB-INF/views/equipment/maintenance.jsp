...
<script type="text/html" id="type">
    {{#  var type = d.type}}
    {{#  if(type === '2'){}}
    <span style="color: #01AAED">保养</span>
    {{#  } else if(type === '1'){ }}
    <span style="color: #FFB800">维修</span>
    {{#  } else { }}
    <span>未知</span>
    {{#  } }}
</script>
...
<script type="text/javascript" src="${ctx}/resources/static/js/equipment/maintenance.js?v=${v}"></script>
