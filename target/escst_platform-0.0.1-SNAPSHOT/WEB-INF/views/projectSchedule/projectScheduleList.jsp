...
<div class="ui-report">
    ...
    <div class="form-inline response-head titlePanel" id="listTools">
        ...
        <div class="tools-btn" id="tools-btn">
            <div class="btn-group">
                <a id="edit_link" class="btn btn-uisblue"><i class="fa fa-pencil-square-o"></i>修改工程进度</a>
            </div>
            <div class="btn-group">
                <a id="confirm_link" class="btn btn-warning"><i class="fa fa-sign-out"></i>确认完成</a>
            </div>
        </div>
    </div>
    <div id="tableBox">
...
<div id="add-edit" class="form-horizontal" data-value="" data-type=0>
    <div class="form-group" kk-contral="require">
        ...
        <div class="col-sm-9">
            <input type="number" kk-prop="value" kk-RE="precentNum" kk-name="" class="form-control" id="precentNum" placeholder="工程进度">
        </div>
    </div>
    <footer>
...
<script type="text/javascript" src="${ctx}/resources/static/js/projectSchedule/projectScheduleList.js?v=${v}"></script>
