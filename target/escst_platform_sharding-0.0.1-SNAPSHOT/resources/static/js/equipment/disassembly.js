var biyueList = {
    ...
    createTable: function () {
        ...
        table.loadTable({
            url:"/equipment/queryDisassemblyList"
            , upData:_self.query()
            , cols: [[
                {type: 'numbers',fixed: 'left'}
                , {field: 'name', title: '设备名称'}
                , {field: 'number', title: '设备编号'}
                , {field: 'disassemblyDate', title: '安装拆卸日期',width:170}
        ...
        layui.table.on('tool(table-list)', function(obj){
            ...
            if(layEvent==="view"){
                biyue.open({
                    title:'查看',
                    url:'/equipment/toView?type=4&equipmentId='+data.id
                })
            }
        })
    },
