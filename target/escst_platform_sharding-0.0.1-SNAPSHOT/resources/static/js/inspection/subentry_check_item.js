function createTable(type) {
    ...
    $('#treeTable').treegrid({
        url: ctx + "/inspection/loadCheckItemTree",
        method: 'post',
        lines: true,
        idField: 'id',
        treeField: 'name',
...
$("#delete_link").click(function () {
    ...
    layer.confirm('您是否要删除该检查项？', {
        btn: ['是','否'] //按钮
    }, function(){
        var index=layer.load();
        $.ajax({
            type: "post",
            url: ctx + '/inspection/deleteCheckItem',
            data:{
                id:node.id,
                "constructionId": constructionId
            },
