            ...
            <div class="ui-report">
                <div class="form-inline response-head titlePanel" id="listTools">
                    ...
                    <div class="tools-btn" id="tools-btn">
                        ...
                        <div class="btn-group">
                            <a id="import_link" class="btn btn-info"><i class="fa fa-sign-out"></i>导入</a>
                        </div>
                        <div class="btn-group">
...
<div id="add-edit" class="form-horizontal" data-value="" data-type=0>
    <div class="form-group" kk-contral="require">
        ...
        <div class="col-sm-9" >
            <input type="text" kk-prop="value" class="form-control" id="planName" placeholder="工程结构名称">
        </div>
    </div>
    <div class="form-group" kk-contral="require">
...
<script type="text/javascript" src="${ctx}/resources/static/js/projectStructure/visibleConstructionList.js?v=${v}"></script>
