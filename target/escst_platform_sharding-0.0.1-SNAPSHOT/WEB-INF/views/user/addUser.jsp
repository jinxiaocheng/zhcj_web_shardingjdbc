...
<div class="table-responsive form-table">
    <form id="userAndPersonform" action="javascript:void(0)">
        <div class="row add_list ">
            <div class="form-group col-xs-5 username row" style="margin: 0" kk-contral="require">
                <label  class="col-xs-4">账号</label>
                <input type="text" class="form-control col-xs-8" kk-prop="value" id="userName" placeholder="请输入账号">
                <input hidden="true" id="orgId" name="orgId" value="${org.id }">
                <input hidden="true" id="constructionId" name="constructionId" value="${org.constructionId }">
            </div>
            <div class="form-group col-xs-5 usertel" kk-contral="require">
                <label class="col-xs-4">姓名</label>
                <input type="text" class="form-control col-xs-8" kk-prop="value" id="name" placeholder="请输入姓名">
            </div>
        </div>
        <div class="row add_list ">
            <div class="form-group col-xs-5 usertel" kk-contral="require">
        ...
        <div class="row add_list ">
            <div class="form-group col-xs-5 usertel">
                ...
                <input type="text" class="form-control col-xs-8" id="mobile" placeholder="请输入手机号">
            </div>
            <div class="form-group col-xs-5 usertel">
         ...
         <%--   <div class="form-group col-xs-5 usertel"> 盛荣要求去掉
                <label class="col-xs-4">身份证</label>
                <input type="text" class="form-control col-xs-8" id="idCard" placeholder="请输入身份证">
            </div>--%>
        </div>
        <div class="row add_list ">
           <%-- <div class="form-group col-xs-5 usertel">
                <label class="col-xs-4">年龄</label>
                <input type="text" class="form-control col-xs-8" id="age" placeholder="请输入年龄">
            </div>--%>
       ...
       <%-- <div class="row add_list ">
            <div class="form-group col-xs-5 usertel">
                ...
                <input type="text" class="form-control col-xs-8" id="email" placeholder="请输入邮箱">
            </div>
        </div>--%>
...
<script type="text/javascript" src="${ctx}/resources/static/js/user/add.js?v=${v}"></script>
