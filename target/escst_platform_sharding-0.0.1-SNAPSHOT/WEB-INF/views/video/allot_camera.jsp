...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/resources/static/css/video/allot_camera.css?v=${v}"/>
    <!--[if lt IE 9]>
...
<script type="text/javascript" src="${ctx}/resources/static/js/video/allot_camera.js?v=${v}"></script>
<script type="text/javascript">
    $(function () {
        allot_camera.getData();
        $("#submit").click(function () {
            allot_camera.sendData();
        })
    })
</script>
</body>
