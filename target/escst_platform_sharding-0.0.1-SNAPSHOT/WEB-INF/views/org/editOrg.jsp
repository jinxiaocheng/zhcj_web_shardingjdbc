...
<div class="ui-report">
    ...
    <div class="form-inline response-head titlePanel" id="listTools" >
        <div class="ui-filter">
            <label>机构名称:</label>
            <input type="text" id="name" placeholder="定义您的角色名称" class="form-control w-110" value="${map.name}"/>
        </div>
        <div class="ui-filter">
            <label>父机构名称:</label>
            <input type="text" id="org" readonly class="form-control w-110" value="${map.fName}"/>
        </div>
    </div>
...
<script type="text/javascript">
    $(function () {
        ...
        user.getData({
            url: ctx + "/org/fetchMenuNodeList?orgId="+orgId,
            data:{},
            type:'post',
            status:"edit"
        });
