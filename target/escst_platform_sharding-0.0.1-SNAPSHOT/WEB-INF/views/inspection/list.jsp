    ...
    <div class="biyue_search layui-form">
        ...
        <div class="search-more-box layui-anim layui-anim-upbit">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="check_item" lay-search lay-filter="check_item">
...
<script type="text/javascript" src="${ctx}/resources/static/js/inspection/inspection.js?v=${v}"></script>
