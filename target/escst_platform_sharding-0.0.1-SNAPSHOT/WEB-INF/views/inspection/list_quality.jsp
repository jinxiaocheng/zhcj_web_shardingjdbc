    ...
    <div class="biyue_search layui-form">
        ...
        <div class="search-more-box layui-anim layui-anim-upbit">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="check_item" placeholder="请输入检查项" autocomplete="off" class="layui-input" >
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="${ctx}/resources/static/js/inspection/inspectionAuality.js?v=${v}"></script>
