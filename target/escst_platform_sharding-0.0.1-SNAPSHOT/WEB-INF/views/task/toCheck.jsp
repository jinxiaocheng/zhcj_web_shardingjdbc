...
<div class="main-info-table">
    <form id="personform">
        ...
        <div class="result" style="border: none">
            <label class="radio-inline"><input name="is_pass" type="radio" value="5" checked="checked" />通过</label>
            <label class="radio-inline"><input name="is_pass" type="radio" value="4"/>不通过</label>
        </div>
...
<div class="footer_btn"><a class="btn btn_submit btn-show-blue" id="task_btn">确认检查</a></div>
...
<script>
    ...
    $(function () {
        ...
        $("#task_btn").on("click",function() {
            ...
            var status=$(".result input[type='radio']:checked").val();//处理意见
