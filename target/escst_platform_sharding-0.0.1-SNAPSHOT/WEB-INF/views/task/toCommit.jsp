...
<div class="main-info-table">
    <form id="personform">
        ...
        <div class="detail-block">
            <input id="file" type="file" class="file" name="files" data-upload-url="#" multiple>
        </div>
...
<div class="footer_btn"><a class="btn btn_submit btn-show-blue" id="task_btn">提交任务</a></div>
