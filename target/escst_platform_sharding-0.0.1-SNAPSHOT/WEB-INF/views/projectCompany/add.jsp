    ...
    <div class="layui-form-item">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" lay-verify="required" placeholder="请输入公司名称" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
...
<script type="text/javascript" src="${ctx}/resources/static/js/projectCompany/projectCompanyAdd.js?v=${v}"></script>
<script>
    $(function () {
        biyue.verify();
        biyue.popDefault();
