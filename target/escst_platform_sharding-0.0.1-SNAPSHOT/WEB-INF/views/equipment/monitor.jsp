...
<div class="biyue_body">
    <div class="biyue_search layui-form">
        <label class="layui-form-label" style="">设备名称</label>
        ...
        <div class="search-more-box layui-anim layui-anim-upbit">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label" style="">设备编号</label>
                <div class="layui-input-inline">
...
<script type="text/html" id="barDemo">
    ...
    {{# }}}
    {{# }}}
    {{# if(d.faceCount>0){num++}}
    <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="faceCount">人脸数据</a>
    {{# }}}
    {{# if(num===0){}}
...
<script type="text/javascript" src="${ctx}/resources/static/js/equipment/monitor.js?v=${v}"></script>
