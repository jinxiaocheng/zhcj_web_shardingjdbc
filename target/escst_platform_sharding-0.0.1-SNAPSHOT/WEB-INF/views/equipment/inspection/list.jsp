    ...
    <div class="biyue_search layui-form">
        ...
        <div class="search-more-box layui-anim layui-anim-upbit">
            ...
            <div class="layui-form-item site">
                ...
                <div class="layui-input-inline">
                    <select name="results" lay-search lay-filter="results">
                        <option value="">选择巡检结果</option>
...
<script type="text/javascript" src="${ctx}/resources/static/js/equipment/inspection.js?v=${v}"></script>
